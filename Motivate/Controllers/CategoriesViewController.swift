...
class CategoriesViewController: UIViewController {
    ...
    var categories : [Categories] = [
        Categories(image: #imageLiteral(resourceName: "purpose"), name: "Find Your Purpose", videos: [
            VideosInCategories(image: #imageLiteral(resourceName: "PURPOSE-1") ,title: "Purpose (Discover Your WHY)", author: "beats Reloaded", duration: "4:02", link: "https://www.youtube.com/watch?v=Z0ZrkBCnfxw"),
